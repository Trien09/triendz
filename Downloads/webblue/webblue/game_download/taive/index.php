...
<?php
   if($_login != null) {
      if($_status == "0") {
   echo '<div class="alert alert-info">Để có thể đăng nhập vào game, bạn cần phải <a href="/active.php">kích hoạt tài khoản</a> (Phí: 20,000 TCoin = 20,000 VND).</div>';
   }
   elseif($_status == "1") {
   echo '<div class="alert alert-info">Tài khoản đang bị khóa, để mở lại bạn cần phải <a href="/active.php">mở khóa tài khoản</a> (Phí: 20,000 TCoin = 20,000 VND).</div>';
   }
   elseif($_status == "-1") {
