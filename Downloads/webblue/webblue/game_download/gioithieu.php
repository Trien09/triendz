...
<div class="container">
  <div class="mt-3 text-center">
    <img src="https://ngocrongsao.com/image/hot.gif"> <a href="https://ngocrongsao.com/dang-ky" class="text-dark">Đăng ký ngay để nhận GiftCode Quà Tặng Tân Thủ</a> <img src="https://ngocrongsao.com/image/hot.gif">
  </div>
  <div>
    <h5 class="text-danger pt-2">Sơ lược về game Chú Bé Rồng Online</h5>
    <div>
      Chú Bé Rồng Online – game nhập vai trực tuyến với cốt truyện và nhân vật dựa trên bộ truyện tranh nổi tiếng Nhật Bản Dragon Ball đã từng làm say lòng bao nhiêu thế hệ độc giả Việt Nam. Bạn sẽ chọn theo hành tinh nào, Trái Đất, Na mếc hay Xay da? Cuộc hành trình tìm kiếm ngọc rồng và chống kẻ hung ác sẽ bắt đầu nằm trong tay bạn.</br>
      Cùng với sự hướng dẫn của các bậc tiền bối và sự nỗ lực của bản thân, bạn có thể đạt đến sức mạnh kinh hoàng, trở thành những chiến binh siêu hạng. Ngoài ra bạn sẽ không phải chiến đấu đơn độc khi xung quanh bạn là những chiến binh cùng chí hướng, cùng hỗ trợ lẫn nhau đối đầu với các thế lực hắc ám.</br>
      Ngọc Rồng là trò chơi trực tuyến đa nền tảng. Bạn có thể chơi được trên máy tính PC Windows, iPhone, Các dòng máy chạy hệ điều hành Android, Windows Phone, và có cả bản Java chạy trên S40, S60 cũ của Nokia. Với chất lượng cao và tốc độ mượt mà trên các loại đường truyền mạng ADSL, 3G, GPRS.</br>
  ...
  <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-01.jpg" class="img-thumbnail">
    </div>
    <div class="text-center">
      Người trái đất với những kỹ năng đặc biệt khó chịu, và rất mạnh khi đi theo nhóm. Đại diện Gohan, Krillin, Yamcha
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-02.jpg"  class="img-thumbnail">
    </div>
    <div class="text-center">
      Khả năng tái tạo và hỗ trợ đồng đội đáng kinh ngạc của người Namếc, với đại diện Ốc tiêu, Pocollo và Kami.
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-03.jpg"  class="img-thumbnail">
    </div>
    <div class="text-center">
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-04.png" class="img-thumbnail">
    </div>
    <div>
      - Nguồn hồi phục KI và HP của các chiến binh chính là bằng đậu thần. Đậu thần có thể nâng cấp được, và mỗi lần nâng cấp sẽ tốn một lượng vàng nhất định. Đậu cấp càng cao thì khả năng hồi phục càng nhiều.</br>
      - Rương đồ dùng để chứa tài sản quý giá không tiện mang theo người.
    </div>
    <h6 class="mt-2 mb-2">3. Bản đồ và NPC:</h6>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-05.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-06.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-07.jpg" class="img-thumbnail">
    </div>
    <div class="text-center">
      Hệ thống bản đồ phong phú, đặc trưng của từng hành tinh.
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-08.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-09.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-10.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-11.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-12.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-13.jpg" class="img-thumbnail">
    </div>
    <div>
      - Game có hệ thống nhiệm vụ chính tuyến phong phú, đi theo cốt truyện. Thông qua những nhiệm vụ này, bạn có thể rèn luyện bản thân và đối đầu với những nhân vật nổi tiếng như Tàu Pảy Pảy, Akkuman, Thượng Đế…</br>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-14.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-15.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-16.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-17.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-18.jpg" class="img-thumbnail">
    </div>
    <h6 class="mt-2 mb-2">8. Đệ Tử</h6>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-19.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-20.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-21.jpg" class="img-thumbnail">
    </div>
    <div>
      - Tham gia theo từng giải: giải Nhi Đồng (dưới Siêu), giải Siêu cấp 1, giải siêu cấp 2, giải siêu cấp 3, giải siêu cấp 4. Mỗi ngày chỉ có 2 lần tổ chức đại hội. Vị trí Đại Hội Võ Thuật là vách núi Kakarot nhé . Đến Ghi Danh để được biêt thêm thông tin
    </div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-24.jpg" class="img-thumbnail">
    </div>
    <div>
      Bao gồm 4 loại:</br>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-25.jpg" class="img-thumbnail">
    </div>
    <div>
    ...
    <h6 class="mt-2 mb-2">12. Giành ngọc rồng sao đen: </h6>
    <div>
      Đây là một chức năng hay dành cho bang hội. Chi tiết về sự kiện xem tại diễn đàn.
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-26.jpg" class="img-thumbnail">
    </div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-28.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-29.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-30.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-31.jpg" class="img-thumbnail">
    </div>
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-32.jpg" class="img-thumbnail">
    </div>
    ...
    <div class="text-center mt-2 mb-2">
      <img src="https://ngocrongsao.com/image/description-33.png" class="img-thumbnail">
    </div>
    <div>
      Capsule kì bí :</br>
...
</div><div class="border-secondary border-top"></div>
<div class="container pt-4 pb-4 text-white">
  <div class="row">
    <div class="col">
      <div class="text-center">
        <div style="font-size: 13px" class="text-dark">
          <small>Desgin By Jone Leo</small></br>
          <small>2023©NGOCRONGSAO.COM</small>
        </div>
      </div>
    </div>
  </div>
...
<script src="https://ngocrongsao.com/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="https://ngocrongsao.com/asset/main.js"></script>